          ...
          <DisclosurePanel className="md:hidden">
            <div className="space-y-1 px-2 pt-2 pb-3">
              ...
              <div className="pt-3  flex justify-end">
                <DisclosureButton                    
                  className="w-[3rem] rounded-md bg-[#286A77] py-2 text-center flex justify-center text-white hover:bg-[#1f515d]"
                >
                  <XMarkIcon aria-hidden="true" className="size-6 open:block" />
                </DisclosureButton>
              </div>
            </div>
          </DisclosurePanel>
