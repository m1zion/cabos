...
function BookExperience() {  
    ...
    useEffect(() => {
        ...
        const adultPrice = parseFloat(experience.adultPrice) || 0;
        const childPrice = parseFloat(experience.childPrice) || 0;
    ...
    }, [adults,children, experience.adultPrice,experience.childPrice,discount]);
    ...
    return (
        ...
        <div 
            ...
            <form onSubmit={handleSubmit(sendEmail)}  className="space-y-4 sm:space-y-6 sm:border sm:border-gray-200 sm:rounded-xl sm:shadow-lg p-4 sm:p-6 bg-white">
                ...
                <input {...register("priceAdult")} type="hidden" id="priceAdult" name="priceAdult" value={experience.adultPrice}/> 
                <input {...register("priceChildren")} type="hidden" id="priceChildren" name="priceChildren" value={experience.childPrice}/> 
                ...
                <div className="flex flex-row justify-between">
                    ...
                    <div className="flex flex-col w-[48%]">
                        ...
                        className={`mb-1 text-sm font-medium ${
                                    experience.childPrice === 0 || experience.childPrice === '-' ? 'text-gray-400' : 'text-gray-600'
                                }`}
                        >{content.children || "Number of Children"} {experience.childPrice == '-' && '(Adults only)'}</label>
                        <input
                            type="number"
