...
function accommodation() {  
    ...
    const { id } = useParams();
    const position = [22.8905, -109.9167]; // Replace with your actual latitude & longitude
    ...
    return (
        <Layout>
        <div className="flex h-[80px] text-[3rem]">{accomodation.id}</div>
        <div className="w-[95%] sm:w-[90%] xl:w-[85%] h-[400px] gap-1 flex flex-col md:flex-row" id ="images"> 
        ...
        <div className="w-[95%] sm:w-[90%] xl:w-[85%] mt-[1rem] mb-[3rem] flex-column items-left">
