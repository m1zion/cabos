    ...
    return (
        ...
        <div className="w-[95%] sm:w-[90%] xl:w-[85%] mb-[3rem]">
            ...
            <div className="flex flex-col">
                <span className="font-medium text-lg text-[#03A6A6] flex items-center gap-1"><ClockIcon aria-hidden="true" className="shrink-[0] block size-5"/>Duration:</span>
                <span>{t.duration}</span>
            </div>
            <div className="flex flex-col">
                <span className="font-medium text-lg text-[#03A6A6] flex items-center gap-1"><CalendarDaysIcon aria-hidden="true" className="shrink-[0] block size-5"/>Schedule:</span>
                <span>{t.period}</span>
            </div>
            <div className="flex flex-col">
                <span className="font-medium text-lg text-[#03A6A6] flex items-center gap-1"><UserGroupIcon aria-hidden="true" className="shrink-[0] block size-5"/>Suitable For:</span>
                <span>{t.age}</span>
            </div>
            <div className="flex flex-col">
                <span className="font-medium text-lg text-[#03A6A6] flex items-center gap-1"><CurrencyDollarIcon aria-hidden="true" className="shrink-[0] block size-5"/>Price:</span>
                <span>{t.price}</span>
            </div>
            <div className="flex flex-col">
                <span className="font-medium text-lg text-[#03A6A6] flex items-center gap-1"><TruckIcon aria-hidden="true" className="shrink-[0] block size-5"/>Round Trip Transportation:</span>
                <span>{t.rounTripTransportation}</span>
            </div>
            {t.additionalData && (
                <div className="flex flex-col sm:col-span-2">
                <span className="font-medium v text-[#03A6A6]">📌 Additional Info:</span>
        ...
        <div className="w-[95%] sm:w-[90%] xl:w-[85%] mb-[3rem] text-gray-600 whitespace-pre-line">
            <button className="w-[100%] sm:w-[14rem] mt-6 py-3 bg-[#03A6A6] text-white font-medium rounded-sm shadow hover:bg-[#028b8b] transition duration-200 cursor-pointer">Reservar</button>  
        </div>
